...
date_default_timezone_set("Asia/Jakarta");
    ...
    if($_POST['absenkelas'] == "Masuk"){
        ...
        mysqli_query($koneksi,"INSERT INTO masukkelas (username, waktumasuk, idpelajaran) VALUES('$username','$waktumasuk','$idpelajaran')");
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="listabsenkeluarsekolah_member.php">List Absen Keluar Sekolah</a>
                                    <a class="nav-link" href="absenkeluarsekolah_member.php">Absen Keluar Sekolah</a>
                                </nav>
                            </div>
                ...
                <main>
                    ...
                    <div class="container">
                        <form method="post">
                            ...
                            <div class="row">
                            <div class="col-25">
                                <label for="fname">ID Pelajaran</label>
                            </div>
                            <div class="col-75">
                                <input type="text" id="fname" name="idpelajaran">
                            </div>
                            </div>

                            <div class="row">
                            <button type="submit" name="absenkelas" class="btn btn-success btn-sm" value="Masuk">Submit</button>
                            </div>
                        </form>
                        </div>

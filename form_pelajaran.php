...
<html lang="en">
  <head>
    ...
    <title>Form Pelajaran</title>
  </head>
  <body>

    
    <h1 class="text-center  pb-3">Form Mata Pelajaran</h1>

    <div class="container">
      <form action="server_pelajaran.php" method="post" class="p-3" >
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="id_pelajaran" placeholder="Masukkan ID Pelajaran" required>
        </div>
         <div class="form-group">

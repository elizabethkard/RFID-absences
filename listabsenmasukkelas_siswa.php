        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <?php 
                        $no = 1;
                        $sql = mysqli_query($koneksi,"select * from masukkelas inner join user u on masukkelas.username=u.username inner join pelajaran p on masukkelas.idpelajaran = p.idpelajaran");
                        while($data = mysqli_fetch_array($sql)){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['jampelajaran']; ?></td>
                                </tr>
                                <?php 
                            }
                            ?>
